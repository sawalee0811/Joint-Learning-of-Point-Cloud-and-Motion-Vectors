...
# Camera rings and distances in original world units
...
def camera_on_sphere(
    ...
    # Distance is provided in original world units
...
def pack_cam_params(
    ...
    # Pulsar expects:
    # [cx, cy, cz, rx, ry, rz, focal, sensor]
...
def prepare_data(root: str) -> None:
    ...
    for ply_path in ply_files:
        ...
        # Scale the geometry once before rendering
...
if __name__ == "__main__":
    ...
    GOF = 6  # Default setting

    # Default example
    sequences = list("a")
    categories = ["longdress"]
